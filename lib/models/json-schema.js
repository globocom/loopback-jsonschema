...
JsonSchema.prototype.createLoopbackModel = function(app) {
    var JsonSchemaModel = ds.createModel(this.modelName, {}, { plural: this.collectionName });
