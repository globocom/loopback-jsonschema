...
module.exports = function readOnlyDefaultValuesHandler(ctx) {
    ...
    var properties = ctx.method.ctor.cachedItemSchema.properties || {};
    var traversePayload = traverse(payload);

    return schemaWalk(properties, [], traversePayload, method);
};
...
function schemaWalk(properties, propertyPath, traversePayload, method) {
    var bodyItems;
    var nestedProperties;
    var path;
    var property;
    ...
    for (var key in properties) {
        ...
        if (property.default) {
            applyDefaultPropertyValue(traversePayload, path, property.default, method);
        }
    }
...
function applyDefaultPropertyValue(traversePayload, path, defaultValue, method) {
