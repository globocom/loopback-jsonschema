...
ItemSchema.prototype.constructModelV2 = function() {
    var indexes = this.indexes || {};
    var model = config.Model.extend(
        this.collectionName,
        modelProperties.call(this),
        { plural: this.collectionName, indexes, http: { path: `v2/:tenantId/${this.collectionName}` } }
    );
    model.sharedClass.name = 'v2:'+this.collectionName;
    model.cachedItemSchema = this;
    addJsonSchemaValidation.call(this, model);
    model.attachTo(ItemSchema.dataSource);
