...
ItemSchema.prototype.registerLoopbackModel = function(app) {
    logger.debug('[ItemSchema#registerLoopbackModel] this:', this);
    logger.debug('[ItemSchema#registerLoopbackModel] this.modelName:', this.modelName);
    logger.debug('[ItemSchema#registerLoopbackModel] this.collectionName:', this.collectionName);
