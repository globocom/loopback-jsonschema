...
var Draft3 = (function(){
    function formatError(result) {
        ...
        result.errors.forEach(function(err) {
            ...
            if (obj.code === 500 && err.details) {
                obj.message = obj.message + ' ('+ err.details+')';
            }
    ...
    function translateMessage(originalMessage) {
        ...
        var errorMessagesMapping = {
            'Format validation failed'          : 'FORMAT_CUSTOM',
            ...
            'String does not match pattern': 'STRING_PATTERN'
        };
...
var Draft4 = (function(){
    function formatError(schema, result) {
        ...
        result.errors.forEach(function(error) {
            ...
            if ((error.schemaPath.indexOf('required') !== -1) && (error.schemaPath.indexOf('/patternProperties/') === -1)) {
